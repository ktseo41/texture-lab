...
const DICT = {
  ko: {
    ...
    'presets.factory': '기본 프리셋',
    'presets.user': '내 프리셋',
    'title.savePreset': '현재 설정을 내 프리셋으로 저장',
    'title.delPreset': '선택한 내 프리셋 삭제',
    'prompt.presetName': '프리셋 이름을 입력하세요',
    'toast.presetSaved': '프리셋을 저장했습니다',
    'toast.presetDeleted': '프리셋을 삭제했습니다',
    'confirm.presetDelete': '"{name}" 프리셋을 삭제할까요?',
    ...
    'srcBg': '배경색',
    'blobColors': '사용 색 수',
    'srcC1': '색 1 (어두움)', 'srcC2': '색 2 (밝음)', 'srcC3': '색 3', 'srcC4': '색 4', 'srcC5': '색 5',
    'gradAngle': '그라디언트 각도°',
    ...
    'textOn': '텍스트 켜기',
    'text': '내용',
    'hint.text': '소스에 그려져 할프톤/그레인에 함께 분해됩니다. 줄바꿈 가능',
    'textSize': '크기 (%높이)', 'textX': '가로 위치 %', 'textY': '세로 위치 %',
    'textColor': '텍스트 색', 'textAlpha': '불투명도',
    'textCursor': '커서 _ 표시',
    'hint.textCursor': '마지막 줄 끝에 노란 언더스코어를 붙입니다',
  ...
  en: {
    ...
    'presets.user': 'My presets',
    'title.savePreset': 'Save current settings as a preset',
    'title.delPreset': 'Delete the selected preset',
    'prompt.presetName': 'Preset name',
    'toast.presetSaved': 'Preset saved',
    'toast.presetDeleted': 'Preset deleted',
    'confirm.presetDelete': 'Delete preset "{name}"?',
    ...
    'srcBg': 'Background',
    'blobColors': 'Color count',
    'srcC1': 'Color 1 (dark)', 'srcC2': 'Color 2 (light)', 'srcC3': 'Color 3', 'srcC4': 'Color 4', 'srcC5': 'Color 5',
    ...
    'textOn': 'Text on',
    'text': 'Content',
    'hint.text': 'Drawn into the source, so it screens into dots/grain. Newlines allowed',
    'textSize': 'Size (% height)', 'textX': 'X position %', 'textY': 'Y position %',
    'textColor': 'Text color', 'textAlpha': 'Opacity',
    'textCursor': 'Cursor _',
    'hint.textCursor': 'Appends a yellow underscore after the last line',
  ...
  ja: {
    ...
    'presets.factory': 'プリセット',
    'presets.user': 'マイプリセット',
    'title.savePreset': '現在の設定をプリセットとして保存',
    'title.delPreset': '選択したプリセットを削除',
    'prompt.presetName': 'プリセット名を入力してください',
    'toast.presetSaved': 'プリセットを保存しました',
    'toast.presetDeleted': 'プリセットを削除しました',
    'confirm.presetDelete': '「{name}」を削除しますか？',
    ...
    'srcBg': '背景色',
    'blobColors': '使用色数',
    'srcC1': '色 1（暗）', 'srcC2': '色 2（明）', 'srcC3': '色 3', 'srcC4': '色 4', 'srcC5': '色 5',
    'gradAngle': 'グラデーション角度°',
    ...
    'textOn': 'テキスト表示',
    'text': '内容',
    'hint.text': 'ソースに描画され、ハーフトーン/グレインと一緒に分解されます。改行可',
    'textSize': 'サイズ（%高さ）', 'textX': '横位置 %', 'textY': '縦位置 %',
    'textColor': 'テキスト色', 'textAlpha': '不透明度',
    'textCursor': 'カーソル _',
    'hint.textCursor': '最終行の末尾に黄色いアンダースコアを付けます',
