...
const DICT = {
  ko: {
    ...
    'fgOn': '글래스 켜기',
    'fgPattern': '유리 무늬',
    'opt.fgPattern.vertical': '세로 줄',
    'opt.fgPattern.reeded': '세로 줄 (입체)',
    'opt.fgPattern.horizontal': '가로 줄',
    'opt.fgPattern.grid': '네모 렌즈',
    'opt.fgPattern.pyramid': '피라미드 격자',
    'opt.fgPattern.diamond': '마름모 렌즈',
    'opt.fgPattern.wave': '물결 줄',
    'opt.fgPattern.honeycomb': '벌집 렌즈',
    'fgWidth': '리브 폭 px',
    'fgIrregular': '리브 불규칙성',
    'hint.fgIrregular': '0=고른 줄·칸, 1=줄 폭과 칸 위치가 들쭉날쭉한 프랙탈 유리',
    'fgRefract': '굴절(압축) px',
  ...
  en: {
    ...
    'fgOn': 'Glass on',
    'fgPattern': 'Glass pattern',
    'opt.fgPattern.vertical': 'Vertical flutes',
    'opt.fgPattern.reeded': 'Vertical flutes (relief)',
    'opt.fgPattern.horizontal': 'Horizontal flutes',
    'opt.fgPattern.grid': 'Square lenses',
    'opt.fgPattern.pyramid': 'Pyramid grid',
    'opt.fgPattern.diamond': 'Diamond lenses',
    'opt.fgPattern.wave': 'Wavy flutes',
    'opt.fgPattern.honeycomb': 'Honeycomb lenses',
    'fgWidth': 'Rib width px',
    'fgIrregular': 'Rib irregularity',
    'hint.fgIrregular': '0 = even ribs and cells, 1 = fractal glass with uneven widths and shifted cells',
  ...
  ja: {
    ...
    'fgOn': 'ガラス有効',
    'fgPattern': 'ガラス模様',
    'opt.fgPattern.vertical': '縦ライン',
    'opt.fgPattern.reeded': '縦ライン（立体）',
    'opt.fgPattern.horizontal': '横ライン',
    'opt.fgPattern.grid': '四角レンズ',
    'opt.fgPattern.pyramid': 'ピラミッド格子',
    'opt.fgPattern.diamond': 'ひし形レンズ',
    'opt.fgPattern.wave': '波ライン',
    'opt.fgPattern.honeycomb': 'ハニカムレンズ',
    'fgWidth': 'リブ幅 px',
    'fgIrregular': 'リブ不規則性',
    'hint.fgIrregular': '0=均一なリブ・セル、1=幅やセル位置が不揃いなフラクタルガラス',
    'fgRefract': '屈折（圧縮）px',
