...
const DICT = {
  ko: {
    ...
    'fgRefract': '굴절(압축) px',
    'hint.fgRefract': '클수록 강한 굴절 — 줄 무늬는 넓은 영역을 압축해 반복. 네모 렌즈는 폭과 같을 때 모자이크(유리 바로 뒤 물체), 더 크면 칸마다 반복(멀리 있는 물체)',
    'fgShade': '하이라이트',
    'fgDispersion': '색 분산',
  ...
  en: {
    ...
    'hint.fgRefract': 'Higher = stronger refraction — flutes compress and repeat a wider slice. Square lenses turn to a mosaic when it equals the width (object right behind the glass), then repeat per cell beyond it (object far away)',
    'fgShade': 'Highlights',
  ...
  ja: {
    ...
    'fgRefract': '屈折（圧縮）px',
    'hint.fgRefract': '大きいほど強い屈折 — ライン柄は広い範囲を圧縮して繰り返す。四角レンズは幅と同じでモザイク（ガラス直後の物体）、それ以上でマスごとに反復（遠くの物体）',
    'fgShade': 'ハイライト',
    'fgDispersion': '色分散',
