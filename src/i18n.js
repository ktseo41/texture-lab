...
const DICT = {
  ko: {
    ...
    'palette': '사진 팔레트',
    'palette.extract': '색 추출',
    'title.extractPalette': '사진의 주요 색을 비율로 뽑아 블롭 소스에 적용',
    'palette.tol.fine': '세밀하게',
    'palette.tol.normal': '보통',
    'palette.tol.broad': '넓게 묶기',
    'hint.palette': '비슷한 색을 하나로 묶어 비율을 계산하고, 가장 많은 색이 배경·나머지가 블롭 색이 됩니다',
    'toast.palette': '사진에서 {n}가지 색을 추출해 적용했습니다',
    ...
    'fgWidth': '리브 폭 px',
    'fgIrregular': '리브 불규칙성',
    'hint.fgIrregular': '0=균일한 세로 리브, 1=폭이 들쭉날쭉한 프랙탈 유리',
    'fgRefract': '굴절(압축) px',
    'hint.fgRefract': '각 리브가 자기보다 넓은 영역을 압축해 반복 — 클수록 강한 유리 굴절',
    'fgShade': '하이라이트',
    'fgDispersion': '색 분산',
  ...
  en: {
    ...
    'palette.extract': 'Extract',
    'title.extractPalette': 'Pull the photo\'s dominant colors by area and apply them to the blob source',
    'palette.tol.fine': 'Fine',
    'palette.tol.normal': 'Normal',
    'palette.tol.broad': 'Broad grouping',
    'hint.palette': 'Similar colors are grouped into one; the largest share becomes the background, the rest become blob colors',
    'toast.palette': 'Extracted and applied {n} colors from the photo',
    ...
    'fgOn': 'Glass on',
    'fgWidth': 'Rib width px',
    'fgIrregular': 'Rib irregularity',
    'hint.fgIrregular': '0 = even vertical ribs, 1 = fractal glass with uneven widths',
    'fgRefract': 'Refraction (squeeze) px',
    'hint.fgRefract': 'Each rib compresses and repeats a wider slice of the image behind it',
    'fgShade': 'Highlights',
    'fgDispersion': 'Dispersion',
  ...
  ja: {
    ...
    'palette': '写真パレット',
    'palette.extract': '色を抽出',
    'title.extractPalette': '写真の主要色を面積比で抽出し、ブロブソースに適用',
    'palette.tol.fine': '細かく',
    'palette.tol.normal': '普通',
    'palette.tol.broad': '広くまとめる',
    'hint.palette': '似た色をひとつにまとめて比率を計算し、最大シェアが背景・残りがブロブ色になります',
    'toast.palette': '写真から{n}色を抽出して適用しました',
    ...
    'fgWidth': 'リブ幅 px',
    'fgIrregular': 'リブ不規則性',
    'hint.fgIrregular': '0=均一な縦リブ、1=幅が不揃いなフラクタルガラス',
    'fgRefract': '屈折（圧縮）px',
    'hint.fgRefract': '各リブが自身より広い範囲を圧縮して繰り返す — 大きいほど強いガラス屈折',
    'fgShade': 'ハイライト',
    'fgDispersion': '色分散',
