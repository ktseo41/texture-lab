...
const DICT = {
  ko: {
    ...
    'gradAngle': '그라디언트 각도°',
    'gradStops': '그라디언트 색 수',
    'gradCX': '시작점 X %', 'gradCY': '시작점 Y %',
    'gradLen': '진행 길이 %',
    'hint.gradLen': '대각선 대비 진행 거리. 짧으면 중간에 멈추고 나머지는 마지막 색으로 채움',
  ...
  en: {
    ...
    'gradCX': 'Start X %', 'gradCY': 'Start Y %',
    'gradLen': 'Travel length %',
    'hint.gradLen': 'Distance relative to the diagonal. Short runs stop mid-canvas and clamp to the last color',
  ...
  ja: {
    ...
    'gradAngle': 'グラデーション角度°',
    'gradStops': 'グラデーション色数',
    'gradCX': '開始点 X %', 'gradCY': '開始点 Y %',
    'gradLen': '進行距離 %',
    'hint.gradLen': '対角線比の進行距離。短いと途中で止まり、残りは最後の色で塗りつぶす',
